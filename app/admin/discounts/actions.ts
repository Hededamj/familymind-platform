...
export async function createDiscountAction(data: {
  ...
  // XOR: kun et af courseId/bundleId må være sat
  if (valid.applicableCourseId && valid.applicableBundleId) {
    throw new Error('Rabatten kan kun gælde for enten et kursus eller en bundel, ikke begge')
  }
  ...
  if (valid.type === 'PERCENTAGE') {
    ...
    couponParams.amount_off = valid.value
  ...
  const discount = await prisma.discountCode.create({
    data: {
      ...
      applicableCourseId: valid.applicableCourseId || null,
      applicableBundleId: valid.applicableBundleId || null,
...
export async function updateDiscountAction(
  ...
  const discount = await prisma.discountCode.update({
    ...
    data: {
      ...
      ...(valid.applicableCourseId !== undefined && { applicableCourseId: valid.applicableCourseId }),
      ...(valid.applicableBundleId !== undefined && { applicableBundleId: valid.applicableBundleId }),
